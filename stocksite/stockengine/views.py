...
def portfolio(request):
    ...
    if request.POST:
        ...
        return render(request, 'result.html', {'the_script':script, 'the_div':div, 'stocktable':tablehtml, 'pie_script':piescript, 'pie_div':piediv, 'stocks':stocks, 'amount':allotment})
